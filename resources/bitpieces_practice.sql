...
greatest(pieces_owned_accum.start_time_, rewards_span.time_) as end_time_,
least(pieces_owned_accum.end_time_, rewards_span.end_time_) as start_time_,
...
SUBSTRING(youtube_link, LOCATE('v=', youtube_link)+2) as youtube_shortcode
from creators
left join pieces_owned_value_current_by_creator
on pieces_owned_value_current_by_creator.creators_id = creators.id
left join rewards_current
